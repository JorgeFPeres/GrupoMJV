...
public class Planos {
	...
	public static void main(String[] args) {
		...
		String basic = "Você escolheu o plano BASIC que oferece: " + "\n"+servicos.get(0).beneficios;		
		String premium ="Você escolheu o plano PREMIUM que oferece: " + "\n"+ servicos.get(0).beneficios + " + " + servicos.get(1).beneficios;
		String gold ="Você escolheu o plano GOLD que oferece: " +"\n"+ servicos.get(0).beneficios + " + " + servicos.get(1).beneficios + " + "
